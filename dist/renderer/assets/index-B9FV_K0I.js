...
//#endregion
//#region src/renderer/pages/AccountManager.tsx
...
function AccountManager() {
	...
	const [loginLoading, setLoginLoading] = (0, import_react.useState)(null);
	const handleFacebookLogin = async (accountId) => {
		setLoginLoading(accountId);
		try {
			const result = await window.api.facebook.login(accountId);
			if (!result.success) showMessage(result.error ?? "Login failed", "error");
		} catch (err) {
			showMessage(err.message, "error");
		}
	...
	const toggleAll = () => {
		if (selectedIds.size === accounts.length) setSelectedIds(/* @__PURE__ */ new Set());
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			showUpload && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-4 p-4 bg-white border border-gray-200 rounded-lg",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						className: "text-sm font-medium text-gray-700 mb-2",
						children: "Upload Access Tokens"
					}),
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
								className: "px-4 py-3 text-left text-gray-600 font-medium",
								children: "Token"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
								className: "px-4 py-3 text-left text-gray-600 font-medium",
						...
						children: accounts.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							colSpan: 7,
							className: "px-4 py-8 text-center text-gray-400",
							children: "No accounts yet. Upload tokens to get started."
						}) }) : accounts.map((account) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									children: account.token_preview
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: `inline-block px-2 py-0.5 rounded-full text-xs font-medium ${statusColor(account.status)}`,
										children: account.status
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "px-4 py-3 text-gray-400 text-xs",
									children: account.last_check ?? "Never"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "px-4 py-3",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
//#endregion
//#region src/renderer/pages/GroupExtractor.tsx
function GroupExtractor() {
	const [accounts, setAccounts] = (0, import_react.useState)([]);
	const [groupIdInput, setGroupIdInput] = (0, import_react.useState)("");
	const [selectedAccountId, setSelectedAccountId] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "text-xl font-bold text-gray-900 mb-4",
				children: "Group Members Extractor"
			}),
			message && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: `mb-4 px-4 py-2 rounded-md text-sm ${message.type === "success" ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`,
				children: message.text
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bg-white border border-gray-200 rounded-lg p-4 mb-4 space-y-4",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-medium",
									children: progress.members_extracted
								})
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "font-medium",
									children: ["#", progress.current_batch]
								})
							] })
						]
					}),
...
//#endregion
//#region src/renderer/App.tsx
function App() {
	const [page, setPage] = (0, import_react.useState)("accounts");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${page === "accounts" ? "bg-blue-50 text-blue-700" : "text-gray-600 hover:bg-gray-100"}`,
					children: "Account Manager"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => setPage("extractor"),
					className: `text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${page === "extractor" ? "bg-blue-50 text-blue-700" : "text-gray-600 hover:bg-gray-100"}`,
					children: "Group Extractor"
				})]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
			className: "flex-1 overflow-auto",
			children: [page === "accounts" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccountManager, {}), page === "extractor" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GroupExtractor, {})]
		})]
	});
}
//#endregion
//#region src/renderer/main.tsx
